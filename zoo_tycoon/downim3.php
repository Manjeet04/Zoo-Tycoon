...
<ul class="tab">
  ...
  <li><a href="javascript:void(0)" class="tablinks" onclick="openCity(event, 'Buy Animal')" >Buy Animal</a></li>
  <li><a href="javascript:void(0)" class="tablinks" onclick="openCity(event, 'Sell Animal')" >Sell Animal</a></li>
...
<div id="Buy Animal" class="tabcontent" >
<font size="4"><div align="center"><h1><span style = "color:lime; text-shadow : 4px 4px 8px red;">WELCOME TO ANIMAL SHOP!!</span></h1></div></font>
<br>
<form action="addbuy.php" method="post">
<font size="4"><span style = "color:aqua; text-shadow : 4px 4px 8px red ; font-family: "Comic Sans MS", cursive, sans-serif">&emsp;&emsp;Select the animal you need to BuY  : </span></font><select name="anibuy">
    <option value="Lion">Lion</option>
    <option value="Tiger">Tiger</option>
    <option value="Giraffe">Giraffe</option>
    <option value="Hippopotamus">Hippopotamus</option>
  ...
  <br><br>
  <font size="4"><span style = "color:aqua; text-shadow : 4px 4px 8px red ; font-family: "Comic Sans MS", cursive, sans-serif">&emsp;&emsp;
   Enter the Quantity of purchase :&emsp;  </span></font>
...
<div id="Sell Animal" class="tabcontent" >
<font size="4"><div align="center"><h1><span style = "color:lime; text-shadow : 4px 4px 8px red;">WELCOME TO ANIMAL SHOP!!</span></h1></div></font>
<br>
<form action="addsell.php" method="post">
<font size="4"><span style = "color:aqua; text-shadow : 4px 4px 8px red ; font-family: "Comic Sans MS", cursive, sans-serif">&emsp;&emsp;Select the animal you need to SeLL  : </span></font><select name="anisell">
    <option value="Lion">Lion</option>
    <option value="Tiger">Tiger</option>
    <option value="Giraffe">Giraffe</option>
    <option value="Hippopotamus">Hippopotamus</option>
  ...
  <br>
  <font size="2"><span style = "color:aqua; text-shadow : 4px 4px 8px red ; font-family: "Comic Sans MS", cursive, sans-serif">&emsp;&emsp;(Sell price is 20% less than buYing price) </span></font>
  <br><br>
  <font size="4"><span style = "color:aqua; text-shadow : 4px 4px 8px red ; font-family: "Comic Sans MS", cursive, sans-serif">&emsp;&emsp;
   Enter the Quantity of selling :&emsp;  </span></font>
   <input type="number" name="count" size="7" pattern="[0-9-']+" />   <br><br>
   &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<input type="submit">
</form>
